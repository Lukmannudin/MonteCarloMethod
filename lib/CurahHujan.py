...
class CurahHujan:
    ...
    def getCurahHujanTable(self):
        ...
        table.append(self.frequency)
        table.append(self.probability)
        table.append(self.cumulativeProbability)
        table.append(self.randomNumberInterval)
